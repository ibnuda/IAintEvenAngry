...
type OffTilesActivity () =
    ...
    override this.OnCreate(bundle) =
        ...
        map.AddLayer(new LayerMBTile(SQLiteConnection.CreateFrom(Assembly.GetExecutingAssembly().GetManifestResourceStream(@"kempen.mbtiles"), "map")))
        ...
        mapView.MapCenter <- new GeoCoordinate(-6.224454, 106.653069)
